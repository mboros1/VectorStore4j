...
sealed public abstract class BaseVectorMemoryReader implements VectorMemoryReader
        permits VectorMemoryReaderF32, VectorMemoryReaderF16 {
    private final VectorLayout layout;
    private final ShardMapper shardMapper;
    private final int rowCount;

    public BaseVectorMemoryReader(VectorLayout layout, int rowCount) {
